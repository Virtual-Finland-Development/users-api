...
public static class VerifyIdentityPerson
{
    ...
    public class Handler : IRequestHandler<Query, User>
    {
        ...
        public async Task<User> Handle(Query request, CancellationToken cancellationToken)
        {
            ...
            _logger.LogAuditLogEvent(AuditLogEvent.Read, request.Context.Items["User"] as RequestAuthenticatedUser ?? throw new Exception("Unknown error occurred on verifying identity"));
