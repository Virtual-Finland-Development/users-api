...
prep-deploy: test
	...
	zip -d ./VirtualFinland.UsersAPI.DatabaseMigrationRunner/bin/Release/net6.0/VirtualFinland.UsersAPI.DatabaseMigrationRunner.zip "VirtualFinland.UsersAPI.deps.json" 
	zip -d ./VirtualFinland.UsersAPI.DatabaseMigrationRunner/bin/Release/net6.0/VirtualFinland.UsersAPI.DatabaseMigrationRunner.zip "VirtualFinland.UsersAPI.runtimeconfig.json" 
